...
# Ensure backend root is on sys.path so storage can be found
# whether this file is run from root or from agents/ subfolder
import sys as _sys
from pathlib import Path as _Path
_backend_root = str(_Path(__file__).resolve().parent.parent)
if _backend_root not in _sys.path:
    _sys.path.insert(0, _backend_root)
# Also add agents/ parent so relative imports work
_agents_root = str(_Path(__file__).resolve().parent)
if _agents_root not in _sys.path:
    _sys.path.insert(0, _agents_root)
...
# =========================================================
# Pipeline event handlers (called from app.py on_events)
# =========================================================
